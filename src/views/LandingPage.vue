      ...
      <div class="grid items-center gap-12 lg:grid-cols-2">
        <div v-reveal>
          <span class="inline-flex items-center gap-2 rounded-full border border-line bg-surface px-3.5 py-1.5 text-xs font-semibold text-ink-soft shadow-s">
            ...
            Now shipping — Let’s Code Aadml IDE
          </span>
        ...
        <div v-reveal class="relative">
          ...
          <div class="pointer-events-none absolute -bottom-6 -right-4 hidden rounded-2xl border border-line bg-surface px-4 py-3 shadow-l sm:block" v-reveal>
            ...
            <div class="mt-0.5 text-xs text-ink-faint">+128 âˆ’42 · verified âœ“</div>
          </div>
        </div>
      </div>
      </div>
...
useMeta({
  title: 'AADML — The Aadml OS for coding & knowledge work',
  ...
  jsonLd: {
    ...
    description: 'The Aadml OS for coding and knowledge work — code-aware, context-aware, cost-aware automation.',
  },
})
...
const features = [
  { icon: 'lucide:code-2', title: 'Let’s Code Aadml IDE', desc: 'Clone a repo in the browser. The agent reads, edits, and proposes reviewable diffs you accept hunk-by-hunk — then exports a GitHub PR. No silent writes.' },
...
const sequence = [
  ...
  '<span class="c-ok">âœ“ py_compile ok · 4 related tests pass</span>',
  '<span class="c-violet">export_pr</span>({ base: <span class="c-str">"main"</span> })',
  '<span class="c-ok">âœ“ PR opened · awaiting review</span>',
]
