<template>
  <div v-if="show" class="fixed inset-0 bg-black/50 flex items-center justify-center z-50 p-4">
    <div class="bg-white rounded-lg shadow-2xl max-w-3xl w-full max-h-[90vh] overflow-hidden flex flex-col">
      <!-- Header -->
      <div class="bg-gradient-to-r from-blue-600 to-blue-700 text-white px-4 sm:px-6 py-3 sm:py-4 flex items-center justify-between">
        <div>
          <h2 class="text-lg sm:text-xl font-bold">Register New Tool</h2>
      ...
      <div class="border-b border-gray-200 bg-gray-50">
        <div class="flex">
          <button
            ...
            class="flex-1 px-3 sm:px-6 py-2.5 sm:py-3 text-xs sm:text-sm font-medium transition"
  ...
  execution:
    ...
    detect_from_files:
      ...
      <!-- Footer -->
      <div class="border-t border-gray-200 px-4 sm:px-6 py-3 sm:py-4 bg-gray-50 flex justify-end gap-2 sm:gap-3">
        <button
          @click="$emit('close')"
