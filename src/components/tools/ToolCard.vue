<template>
  ...
  >
    <div class="flex items-center gap-6 p-6">
      <!-- Tool Icon -->
      <div class="w-14 h-14 bg-gradient-to-br from-blue-600 to-purple-600 rounded-xl flex items-center justify-center text-2xl shadow-md flex-shrink-0">
        {{ getToolIcon(tool.category) }}
      </div>
      ...
      <div class="flex-1 min-w-0">
        <div class="flex items-start justify-between gap-4 mb-2">
          ...
          <span
            :class="[
              'px-3 py-1.5 text-xs rounded-full font-semibold flex-shrink-0',
              tool.enabled
