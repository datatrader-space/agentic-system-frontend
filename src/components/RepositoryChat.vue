      ...
      <form @submit.prevent="sendMessage" class="flex gap-2">
        ...
        <div class="flex flex-col gap-2">
          ...
          <button
            ...
            @click="stopExecution"
            type="button"
            class="px-3 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors text-xs"
          ...
          <button
            ...
            @click="retryLast"
            type="button"
            class="px-3 py-2 bg-gray-600 text-white rounded-lg hover:bg-gray-700 transition-colors text-xs"
...
// Fix: Auto-scroll on messages change
watch(
  () => messages.value, 
  async () => {
    await nextTick()
